...
new_model = "Llama-2-7b-fintunedd"
...
output_dir = "/home/u590531/llm/Software2result/"
...
save_directory = "/home/u590531/llm/Software2/"  # Specify the path where you want to save the model
...
5 Results it improves minority class predictions with very limited loss in
...
the changes in F1-score due to two-phase training with RUS.""" # replace the command here with something relevant to your task
